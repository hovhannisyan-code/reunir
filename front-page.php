        ...
        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="single-about-box">
                                    <div class="icon-box-outer bg-ex">
                                        <div class="icon-box">
                                            <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/expierence.svg" alt="#">
                                        </div>
                                    </div>
                                    <h3>Expierence</h3>
            ...
            <div class="col-lg-5">
                <div class="about-right">
                    <div class="video-box">
                        <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/about-bg.jpg" alt="#">
                        <div class="icon-box">
            ...
            <div class="choose-section-carousel">
                ...
                <div class="col">
                    <div class="single-item">
                        <div class="icon-box">
                            <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/daily-income.svg" alt="#">
                        </div>
                        <div class="text-box">
                ...
                <div class="col">
                    <div class="single-item">
                        <div class="icon-box">
                            <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/withdraw1.svg" alt="#">
                        </div>
                        <div class="text-box">
                ...
                <div class="col">
                    <div class="single-item">
                        <div class="icon-box">
                            <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/invest-fild.svg" alt="#">
                        </div>
                        <div class="text-box">
                ...
                <div class="col">
                    <div class="single-item">
                        <div class="icon-box">
                            <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/security.svg" alt="#">
                        </div>
                        <div class="text-box">
                ...
                <div class="col">
                    <div class="single-item">
                        <div class="icon-box">
                            <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/customer-service.svg" alt="#">
                        </div>
                        <div class="text-box">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 text-center reunir-content-center">
                    <div class="single-box location-left">
                        <div class="img-box">
                            <div class="font-side">
                                <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/sign-up.svg" alt="#">
                            </div>
                            <div class="back-side">
                                <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/sign-up.svg" alt="#">
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 text-center reunir-content-center">
                    <div class="single-box">
                        <div class="img-box">
                            <div class="font-side">
                                <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/deposit.svg" alt="#">
                            </div>
                            <div class="back-side">
                                <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/deposit.svg" alt="#">
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 text-center reunir-content-center">
                    <div class="single-box location-right">
                        <div class="img-box">
                            <div class="font-side">
                                <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/withdraw-1.svg" alt="#">
                            </div>
                            <div class="back-side">
                                <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/withdraw-1.svg" alt="#">
                            </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-img">
                            <div class="img-outline">
                                <img src="<?php echo SKYR_ASSETS_DIR_URI; ?>/img/table-img2.png" alt="#">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-header questions-card-header" id="withdrawal-headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link questions-btn-link" data-toggle="collapse" data-target="#withdrawal-collapseOne" aria-expanded="true" aria-controls="questions-pills-basic-tab">
                                            What Are The Main Advantages Of Reunir 7777777777777777?
                                        </button>
                                    </h5>
                                </div>
                                ...
                                <div class="card-header questions-card-header" id="investing-headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link questions-btn-link" data-toggle="collapse" data-target="#investing-collapseOne" aria-expanded="true" aria-controls="questions-pills-basic-tab">
                                            What Are The Main Advantages Of Reunir 22222222222222222?
                                        </button>
                                    </h5>
                                </div>
                                ...
                                <div class="card-header questions-card-header" id="basic-headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link questions-btn-link" data-toggle="collapse" data-target="#basic-collapseOne" aria-expanded="true" aria-controls="questions-pills-basic-tab">
                                            What Are The Main Advantages Of Reunir 66666666666666?
                                        </button>
                                    </h5>
                                </div>
                                ...
                                <div class="card-header questions-card-header" id="referral-headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link questions-btn-link" data-toggle="collapse" data-target="#referral-collapseOne" aria-expanded="true" aria-controls="questions-pills-basic-tab">
                                            What Are The Main Advantages Of Reunir 1111111111444?
                                        </button>
                                    </h5>
                                </div>
